...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        posicaoLimpa = (x,y)
        self.cleanTitles[posicaoLimpa] = 1
    ...
    def isTileCleaned(self, m, n):
        ...
        if posicaoLimpa in self.cleanTitles:
            return True
        else:
            return False
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        if pos.getX()<self.width and pos.getY()< self.height and pos.getX()>=0 and pos.getX()>=0:
